...
/**
 * an interface for one to one Color generators for scores
 * @author ted
 *
 */
...
{
    /**
     * get a color from a score based on this algorithm
     * @param score the score to generate
     * @return the one->one color for this score
     */
